...
def test_masks_len(my_number,problem_number):
   ...
   # assert get_mask_card_number(problem_number) == 'Неверное количество цифр'


def test_len_account_card(my_number):
    assert get_mask_account(my_number) == 'Мало цифр'

#def test_get_mask_card_number_good(good_card_number):
#    assert get_mask_card_number(good_card_number) == '1234 56** **** 5678'
